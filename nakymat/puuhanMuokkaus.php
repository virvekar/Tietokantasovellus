...
<form class="form-horizontal" role="form" action="lomake.html" method="POST">
    <div class="form-group">
        ...
        <div class="col-md-10">
            <input type="text"  value="Artemis Fowl" class="form-control" id="inputPuuhanNimi" name="puuhanNimi" >
        </div>
    </div>
    <div class="form-group">
        <div class="col-md-3">                 
        ...
        <div class="col-md-3 ">
            <input type="text" value="Kirjan lukeminen" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label for="inputKuvaus" class="col-md-2 control-label">Kuvaus</label>
        <div class="col-md-10">
            <input type="text" value="Hupaisa kirja Eoin Colferilta" style="height: 200px; width: 300px" class="form-control" id="inputKuvaus" name="kuvaus" >
        </div>
    </div>
    <div class="form-group">
        <label for="inputKesto" class="col-md-2 control-label">Kesto</label>
        <div class="col-md-10">
            <input type="text" value="vapaa-valintainen" class="form-control" id="inputKesto" name="kesto" >
        </div>
    </div>
    <div class="form-group">
        <label for="inputHenkilomaara" class="col-md-2 control-label">Henkilömäärä</label>
        <div class="col-md-10">
            <input type="text" value="1" class="form-control" id="inputHenkilomaara" name="henkilomaara">
        </div>
    </div>
    <div class="form-group">
        <div class="col-md-3">                 
        ...
        <div class="col-md-3 ">
            <input type="text" value="Missä Tahansa" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <div class="col-md-3">                 
        ...
        <div class="col-md-3 ">
            <input type="text" value="Ei erityistaitoja" class="form-control">
        </div>
    </div>
    <div class="form-group">
